                    ...
                    <x-slot name="trigger">
                        @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                            <button class="flex text-sm border-2 border-transparent rounded-full focus:outline-none focus:border-gray-300 transition">
                                <img class="size-8 rounded-full object-cover" src="{{ Auth::user()->profile_photo_url }}" alt="{{ strtoupper(substr(Auth::user()->first_name, 0, 1) . substr(Auth::user()->last_name, 0, 1)) }}" />
                                <span class="absolute inset-0 flex items-center justify-center text-dark text-sm font-semibold">
                        ...
                        <x-slot name="content">
                            ...
                            @can('administration management')    
                                ...
                                @can('members management')    
                                    <x-dropdown-link href="{{ route('members-management.all') }}">
                                        {{ __('Members') }}
                                    </x-dropdown-link>
                                @endcan 
                                @can('post management')    
